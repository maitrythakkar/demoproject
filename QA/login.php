				...
				<div class="row">
						...
						<div class="basic-login">
							<form role="form" role="form" method="post" action="<?php echo $_SERVER["PHP_SELF"] ?>">
								...
								<div class="form-group">
									...
									<button type="submit" name="btnin" class="btn pull-right">Login</button>
					...
					<div class="col-sm-7 social-login">
						...
						<div class="social-login-buttons">
							<a href="https://www.facebook.com/" class="btn-facebook-login">Login with Facebook</a>
							<a href="https://twitter.com/" class="btn-twitter-login">Login with Twitter</a>
						</div>
						<div class="clearfix"></div>
